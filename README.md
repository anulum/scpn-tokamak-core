...
Reactor Systems Research Group. This repository is the designated owner of
device-level truth for the two tokamak configurations of the SCPN Phase
...
physics — the closed forms of a shaped torus and its vacuum field,
...
This repository owns, for the tokamak device family:

- the device boundary: plant and experiment truth, shot lifecycle, and
  configuration policy for conventional and spherical tokamaks;
...
- **Solver mathematics and validation evidence**: `SCPN-FUSION-CORE` remains
  the canonical owner of shared solver surfaces, including its current
  tokamak-adjacent mathematics, until an exact surface passes the reactor
  family migration gate. No solver code exists in, or was copied into, this
  repository.
...
plant/shot lifecycle, diagnostics and clocks, solver/evidence/control
contract) and the position of this repository in the SCPN ecosystem are
