...
# SCPN Tokamak Core — portable diagnostic-plan envelope
...
from scpn_tokamak_core.configuration import OWNED_CONFIGURATIONS
...
PROJECT: Final = "SCPN-TOKAMAK-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_tokamak_core.observability.CATALOGUE_BINDING`.
    plan_identifier
